...
MIDDLEWARE = [
    ...
    'patients.middleware.LogClientRequestsMiddleware',
]
...
STATICFILES_FINDERS = [
    ...
    'healthcare_api.static_overrides.DRFStaticFinder',
]
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # Allow all users (authenticated or not) to access the API
    ],
}
